...
export default function LayoutConfigPanel({
  ...
  return (
    <div className="min-h-full divide-y divide-border/70 bg-card [&>section]:px-5 [&>section]:py-7 sm:[&>section]:px-8 lg:[&>section]:px-10 lg:[&>section]:py-9 xl:[&>section]:px-12">
      {/* ── Form type ─────────────────────────────────────────── */}
      <section>
